...
*Date: 10-05-2018
*Title: Preparing data for multilevel multinomial logistic regression (STATA/R)
...
GET
    FILE='/Users/eigenaar/Downloads/ESS7e02.1/ESS7e02.1_F1.sav'.
...
** 7. Denmark
FREQUENCIES prtvtcdk.
recode prtvtcdk 
                        (1=3) /*Social Democrats
                        (2=2) /*Danish Social Liberal Party
                        (3=2) /*Conservative People's Party
                        (4=3) /*Socialist People's Party
                        (5=1) /*Danish People's Party
                        (6=2) /*Christian Democrats
                        (7=2) /*Venstre
                        (8=2) /*Liberal Alliance
                        (9=0) /*Red-Green Alliance
                        (66=0) (ELSE=SYSMIS) 
                                                         into yall_DEN.
        CROSSTABS prtvtcdk by yall_DEN.
...
recode prtvtcfi 
                      ...
                      (7=0) /*Change 2011
                      (8=0) /*The Pirate Party (not included)
                      (10=0) /*Independence Party (not included)
                      (12=0) /*Green League
                      (13=3) /*Social Democratic Party of Finland
                      (14=3) /*Left Alliance
                      (15=3) /*Communist Party (not included)
                      (16=3) /*The Communist Workers' Party (not included)
                      (66=0) (ELSE=SYSMIS) 
                                                       into yall_FI.
        CROSSTABS prtvtcfi by yall_FI.
...
**13. Lithuania. (Political Party 'The Way of Courage' (6) populist? disregard).
FREQUENCIES prtvalt3.
recode prtvalt3 
                       (1=2) /*Liberal Movement
                       (3=3) /*Labour Party
                       (4=0) /*Democratic Labour Party and Unity (not included)
                       (5=2) /*Homeland Union - Lithuanian Christian Democrats
                       (7=0) /*Electoral Action of Poles in Lithuania
                       (8=3) /*Social Democratic Party of Lithuania
                       (9=1) /*Order and Justice
                       (10=2) /*Lithuanian Centre Party
                       (11=0) /*Social Democratic Party of Lithuania
                       (13=0) /*National Unity Union (not included)
                       (16=0) /*Socialist People's Front (not included)
                       (17=0) /*Lithuanian Farmers and Greens Union 
                       (28 thru 55=0) /*Other
                       (66=0) (ELSE=SYSMIS) 
                                                       into yall_LT.
        CROSSTABS prtvalt3 by yall_LT.
...
recode prtvtcpl 
                       (1=2) /*Congress of the New Right
                       (2=2) /*Civic Platform
                       (3=2) /*Poland Comes First
                       (4=3) /*Polish Labour Party
                       (5=2) /*Polish Peasants Party
                       (6=1) /*Law and Justice Party
                       (7=3) /*Palikot Movement
                       (8=3) /*Democratic Left Alliance
                       (9=0) /*Others
                       (66=0) (ELSE=SYSMIS) 
                                                       into yall_PL.
        CROSSTABS prtvtcpl by yall_PL.
...
recode prtvteee 
                        ...
                        (6=1) /*Konservatiivne Rahvaerakond (endie Rahvaliit)
                        (7=0) /*Vene Erakond Eestis
                        (8=2) /*Erakond Eesti Kristlikud Demokraadid
                        (9=0) /*Eesti Iseseisvuspartei
                        (10=0) /*Üksikkandidaadid või muud
                        (66=0) (ELSE=SYSMIS) 
                                                        into yall_EE.

CROSSTABS prtvteee by yall_EE.
...
recode prtvtesi 
                      ...
                      (3=2) /*Civic Party
                      (4=3) /*Positive Slovenia
                      (5=3) /*Social Democrats
...
COMPUTE ypart =SUM (yall_DE, yall_NL, yall_AT, yall_BE, yall_CH, yall_CZ, yall_DEN, 
...
IF (cntry = "AT") or (cntry = "BE") or (cntry = "CH") or (cntry = "DE") or (cntry = "DK") or (cntry = "FI") 
...
VARIABLE LABELS glo_ptrust "Global political trust (0-10)".
DESCRIPTIVES glo_ptrust.

**Internal political efficacy.

FREQUENCIES actrolg cptppol etapapl.
...
recode cptppol 
                        ...
                        (else=SYSMIS)  
                                             into inefficacy2.
**recode etapapl (0 thru 10 = COPY)  (else=SYSMIS) into inefficacy3.
...
FREQUENCIES psppsgv psppipl ptcpplt.
...
recode psppipl 
                       ...
                       (else=SYSMIS)  
                                              into exefficacy2.
**recode ptcpplt (0 thru 10 = COPY)  (else=SYSMIS) into exefficacy3.
...
or (cntry = "DK") or (cntry = "FI") or (cntry = "FR") or (cntry = "EE")
...
SAVE OUTFILE= '/Users/eigenaar/Desktop/ESS MERGE/ESS7M.sav'
    /KEEP = essround cntrytype cntry yall pincome education unemployed inrdstrbtn autsen
                 ethreat nat_ptrust glo_ptrust exefficacy age gender prtvtcpl prtvtehu
    /COMPRESSED.
